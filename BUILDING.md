...
```bash
arch -arm64 ./ethos_build_env/bin/python3 -m nuitka --standalone --onefile --onefile-no-strip -o binary/ethos-arm64 main.py
```
...
arch -x86_64 ./ethos_build_env_x86/bin/python3 -m nuitka --standalone --onefile --onefile-no-strip -o binary/ethos-x86_64 main.py
```
